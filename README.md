# Project 3 - Skye-stagram

**Skye-stagram** is a photo sharing app similar to Instagram but using Parse as its backend.
...
- [x] User can use a navigation drawer to log out of the app
